...
import (
	...
	"github.com/nimbus-cloud/cli/cf/commands/domain"
	"github.com/nimbus-cloud/cli/cf/commands/organization"
	...
	"github.com/nimbus-cloud/cli/cf/commands/servicebroker"
	"github.com/nimbus-cloud/cli/cf/commands/space"
	"github.com/nimbus-cloud/cli/cf/commands/user"
...
func NewFactory(ui terminal.UI, config configuration.ReadWriter, manifestRepo manifest.ManifestRepository, repoLocator api.RepositoryLocator) (factory concreteFactory) {
	...
	factory.cmdsByName["set-schema"] = service.NewSetSchema(ui, config, repoLocator.GetServiceRepository())
