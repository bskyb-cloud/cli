...
func (fake *FakeServiceRepository) SetSchema(instance models.ServiceInstance, schema string) (apiErr error) {
	return nil
}

func (fake *FakeServiceRepository) GetSchema(instance models.ServiceInstance) (schema string, apiErr error) {
	return "", nil
}
